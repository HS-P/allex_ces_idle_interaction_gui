...
class TrackerManager:
    ...
    def __init__(
        ...
        # 소스 코드: src/allex_ces_idle_interaction/config/botsort.yaml
        # 설치된 환경: install/allex_ces_idle_interaction/share/allex_ces_idle_interaction/config/botsort.yaml
        possible_paths = [
        ...
        # __file__이 install/allex_ces_idle_interaction/lib/python3.10/site-packages/allex_ces_idle_interaction/person_tracker_botsort_reid.py인 경우
        # install/allex_ces_idle_interaction/share/allex_ces_idle_interaction/config/botsort.yaml을 찾아야 함
        ...
        if 'install' in parts:
            ...
            if install_idx + 1 < len(parts):
                install_base = Path(*parts[:install_idx + 2])  # install/allex_ces_idle_interaction까지
                share_path = install_base / "share" / "allex_ces_idle_interaction" / "config" / "botsort.yaml"
