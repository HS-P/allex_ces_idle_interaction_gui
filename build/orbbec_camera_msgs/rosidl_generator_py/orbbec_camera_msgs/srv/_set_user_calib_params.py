...
class Metaclass_SetUserCalibParams_Request(type):
    """Metaclass of message 'SetUserCalibParams_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_user_calib_params__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_user_calib_params__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_user_calib_params__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_user_calib_params__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_user_calib_params__request
...
class SetUserCalibParams_Request(metaclass=Metaclass_SetUserCalibParams_Request):
    """Message class 'SetUserCalibParams_Request'."""
...
class Metaclass_SetUserCalibParams_Response(type):
    """Metaclass of message 'SetUserCalibParams_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_user_calib_params__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_user_calib_params__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_user_calib_params__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_user_calib_params__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_user_calib_params__response
...
class SetUserCalibParams_Response(metaclass=Metaclass_SetUserCalibParams_Response):
    """Message class 'SetUserCalibParams_Response'."""
...
class Metaclass_SetUserCalibParams(type):
    """Metaclass of service 'SetUserCalibParams'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'orbbec_camera_msgs.srv.SetUserCalibParams')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__set_user_calib_params

            from orbbec_camera_msgs.srv import _set_user_calib_params
            if _set_user_calib_params.Metaclass_SetUserCalibParams_Request._TYPE_SUPPORT is None:
                _set_user_calib_params.Metaclass_SetUserCalibParams_Request.__import_type_support__()
            if _set_user_calib_params.Metaclass_SetUserCalibParams_Response._TYPE_SUPPORT is None:
                _set_user_calib_params.Metaclass_SetUserCalibParams_Response.__import_type_support__()


class SetUserCalibParams(metaclass=Metaclass_SetUserCalibParams):
    from orbbec_camera_msgs.srv._set_user_calib_params import SetUserCalibParams_Request as Request
    from orbbec_camera_msgs.srv._set_user_calib_params import SetUserCalibParams_Response as Response
